Shader "Hidden/HDRP/AOResolve"
{
    HLSLINCLUDE
        ...
        TEXTURE2D_ARRAY(_DepthValuesTexture);
        TEXTURE2D_ARRAY(_MultiAmbientOcclusionTexture);
        ...
        float Frag(Varyings input) : SV_Target
        {
            ...
            float4 depthValues = LOAD_TEXTURE2D_EYE(_DepthValuesTexture, pixelCoords);
            ...
            // Fetch the AO values
            float2 aoValues = LOAD_TEXTURE2D_EYE(_MultiAmbientOcclusionTexture, pixelCoords).xy;
