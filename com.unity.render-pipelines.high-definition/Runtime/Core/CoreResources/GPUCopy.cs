...
namespace UnityEngine.Experimental.Rendering
{
    public class GPUCopy
    {
        ...
        public void SampleCopyChannel_xyzw2x(CommandBuffer cmd, RTHandleSystem.RTHandle source, RTHandleSystem.RTHandle target, RectInt rect)
        {
            ...
            Debug.Assert(XRGraphics.computePassCount == source.rt.volumeDepth);
            Debug.Assert(XRGraphics.computePassCount == target.rt.volumeDepth);

            SampleCopyChannel(cmd, rect, XRGraphics.computePassCount, _Source4, source, _Result1, target, k_SampleKernel_xyzw2x_8, k_SampleKernel_xyzw2x_1);
        }
